...
<head>
    ...
    <title>Search Pembelian | Sistem Informasi PT. Farmasi OK</title>
    <!-- Favicon-->
                    ...
                    <div class="card">
                        ...
                        <% 
                            ...
                            try {
                                ...
                                String sql = "select pembelian.kode_transaksi, nama_distributor, nama_pegawai, id_obat, nama_obat, jumlah, total, tanggal from pembelian INNER JOIN distributor USING (id_distributor) INNER JOIN pegawai USING (id_pegawai) INNER JOIN obat USING (id_obat) INNER JOIN detail_pembelian USING (no)";
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <% while(rs.next()){ %> 
                                        <tr>
                                            <td><%= rs.getString("nama_distributor") %></td>
                                            <td><%= rs.getString("nama_pegawai") %></td>
                                            <td><%= rs.getString("nama_obat") %></td>
                                            <td>Rp. <%= rs.getString("total") %></td>
                                            <td><%= rs.getString("tanggal") %></td>
                                            <td><a href="pembelian-search.jsp?delete=<%=rs.getString("kode_transaksi")%>&jumlah=<%=rs.getString("jumlah")%>&idobat=<%=rs.getString("id_obat")%>" onclick="return confirm('Apakah Anda Akan Menghapus Data Obat Berikut ini ?')"><center><i class="fa fa-bitbucket fa-fw"></i></center></td>
                                        </tr>
                                        <% }
                                            stmt.close();
                                            conn.close();
...
<script type="text/javascript">
    ...
    function berhasil(){
        ...
        window.location.href = "pembelian-search.jsp";
    }
    
</script>                                    
                                    <jsp:useBean id="delete" class="pembelian.DeletePembelian"/>
            <% 
                if (request.getParameter("delete") != null && request.getParameter("delete") != "") {
                        delete.kodeTransaksi = request.getParameter("delete");
                        delete.jumlahPembelian = Integer.parseInt(request.getParameter("jumlah"));
