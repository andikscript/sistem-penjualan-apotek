...
<head>
    ...
    <title>Update Distributor | Sistem Informasi PT. Farmasi OK</title>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="distributor-insert.jsp">Insert</a>
                            </li>
                            <li>
                                <a href="distributor-search.jsp">Search</a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
<script type="text/javascript">
    ...
    function berhasil(){
        ...
        window.location.href = "distributor-search.jsp";
    }
    
    function gagal(){
        alert("Gagal Update Data\n Ada Kesalahan Dalam Update Data. ");
        window.location.href = "distributor-update.jsp";
    }
</script>
    <section class="content">
        <div class="container-fluid">
            <jsp:useBean id="update" class="distributor.UpdateDistributor"/>
            <% 
                ...
                if (request.getParameter("namadistributor")!= null && request.getParameter("namadistributor") != "") {
                    update.idDistributor = id;
                    update.namaDistributor = request.getParameter("namadistributor");
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="distributor-update.jsp">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="namadistributor" maxlength="60" value="<%=nama%>" required>
                                        <label class="form-label">Nama Distributor / perbarui nama</label>
                                    </div>
                                    <div class="help-info">Input Nama Distributor (tanpa titik, contoh: PT ASA)</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="alamat" maxlength="255" value="<%=alamat%>" required>
                                        <label class="form-label">Alamat / perbarui alamat</label>
                                    </div>
                                    <div class="help-info">Input Alamat Distributor</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nohp" maxlength="20" value="<%=noHp%>" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="email" class="form-control" name="email" maxlength="60" value="<%=email%>" required>
