...
<head>
    ...
    <title>Insert Distributor | Sistem Informasi PT. Farmasi OK</title>
...
<script type="text/javascript">
    ...
    function berhasil(){
        ...
        window.location.href = "distributor-insert.jsp";
    }
    
    function gagal(){
        alert("Gagal Input Data\n Ada Kesalahan Dalam Input Data. \nCek Kembali ID atau Data yang sudah terdaftar");
        window.location.href = "distributor-insert.jsp";
    }
</script>
    <section class="content">
        <div class="container-fluid">
            <jsp:useBean id="insert" class="distributor.InsertDistributor"/>
            <% 
                if (request.getParameter("namadistributor") != null && request.getParameter("namadistributor") != "") {
                    insert.namaDistributor = request.getParameter("namadistributor");
                    insert.alamat = request.getParameter("alamat");
                    insert.noHp = request.getParameter("nohp");
                    insert.email = request.getParameter("email");
                    insert.run();
                }    
                    if (insert.a == 1) {%>
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="1" class="form-control" name="namadistributor" maxlength="60" required>
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="help-info">Input Alamat Produsen</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="nohp" maxlength="20" required>
                                        <label class="form-label">No. Hp</label>
                                    </div>
                                    <div class="help-info">Max. Panjang: 20 karakter tanpa spasi dan karakter khusus lain (+62)</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
