...
<head>
    ...
    <title>Search Distributor | Sistem Informasi PT. Farmasi OK</title>
    <!-- Favicon-->
...
<script type="text/javascript">
    ...
    function berhasil(){
        ...
        window.location.href = "distributor-search.jsp";
                                        ...
                                        <jsp:useBean id="delete" class="distributor.DeleteDistributor"/>
            <% 
                if (request.getParameter("delete") != null && request.getParameter("delete") != "") {
                        delete.idDistributor = request.getParameter("delete");
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="distributor-update.jsp?update=<%=rs.getString("id_distributor")%>&nama=<%=rs.getString("nama_distributor")%>&alamat=<%=rs.getString("alamat")%>&nohp=<%=rs.getString("no_hp")%>&email=<%=rs.getString("email")%>"" onclick="return confirm('Apakah Anda Akan Mengupdate Data Distributor Berikut ini ?')"><center><i class="fa fa-edit fa-fw"></i></center></a></td>
                                            <td><a href="distributor-search.jsp?delete=<%=rs.getString("id_distributor")%>" onclick="return confirm('Apakah Anda Akan Menghapus Data Distributor Berikut ini ?')"><center><i class="fa fa-bitbucket fa-fw"></i></center></td>
                                        </tr>
                                        <% }
                                            stmt.close();
                                            conn.close();
