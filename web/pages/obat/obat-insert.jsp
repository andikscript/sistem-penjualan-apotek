...
<head>
    ...
    <title>Insert Obat | Sistem Informasi PT. Farmasi OK</title>
...
<script type="text/javascript">
    function berhasil(){
        ...
        window.location.href = "obat-insert.jsp";
    }
    ...
    <section class="content">
        <div class="container-fluid">
            <jsp:useBean id="insert" class="obat.InsertObat"/>
            <% 
                if (request.getParameter("idkategori") != null &&  request.getParameter("idkategori") != "" && request.getParameter("idjenis") != null &&  request.getParameter("idjenis") != "") {
                    //obat dan detail obat
                    insert.namaObat = request.getParameter("namaobat");
                    insert.idKategori = request.getParameter("idkategori");
                    insert.idJenis = request.getParameter("idjenis");
                    //stok
                    insert.stok = Integer.parseInt(request.getParameter("stok"));
                    insert.stokLimit = Integer.parseInt(request.getParameter("stoklimit"));
                    insert.run();
                }
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST">
                                <div class="form-group form-float">
                                    ...
                                    <div class="help-info">Silahkan Input Nama Obat</div>
                                </div>
                                <div class="form-group form-float">
                                        ...
                                        <select name="idkategori" required>
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    while(rs.next()){%>
                                                        <option value="<%= rs.getString("id_kategori") %>"><%= rs.getString("kategori") %></option>
                                                    <%}
                                                    stmt.close();
                                                    conn.close();
                                                        } catch (Exception e){
                                    ...
                                    <div class="style-selected">
                                        <select name="idjenis" required>
                                            ...
                                            <% try {
                                                    ...
                                                    rs = stmt.executeQuery(sql);
                                                    while(rs.next()){%>
                                                        <option value="<%= rs.getString("id_jenis") %>"><%= rs.getString("jenis") %></option>
                                                    <%}
                                                    stmt.close();
                                                    conn.close();
                                                        } catch (Exception e){
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="help-info">Silahkan Input Stok Obat</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" class="form-control" name="stoklimit" required>
                                        <label class="form-label">Limit Stok</label>
                                    </div>
                                    <div class="help-info">Silahkan Input Limit Stok Obat</div>
                                </div>         
