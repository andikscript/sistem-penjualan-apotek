...
<head>
    ...
    <title>Update Obat | Sistem Informasi PT. Farmasi OK</title>
...
<script type="text/javascript">
    ...
    function gagal(){
        ...
        window.location.href = "obat-update.jsp";
    } 
</script> 
    <section class="content">
        <div class="container-fluid">
            <jsp:useBean id="update" class="obat.UpdateObat"/>
            <% 
                ...
                if (request.getParameter("namaobat") != null && request.getParameter("namaobat") != "") {
                    update.idObat = id;
                    update.idStok = stok;
                    update.namaObat = request.getParameter("namaobat");
                    update.idKategori = request.getParameter("idkategori");
                    update.idJenis = request.getParameter("idjenis");
                    update.run();
                }
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST" action="obat-update.jsp">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="namaobat" value="<%= nama %>" required>
                                        <label class="form-label">Nama Obat</label>
                                    </div>
                                    <div class="help-info">Silahkan Update Nama Obat</div>
                                </div>
                                <div class="form-group form-float">
