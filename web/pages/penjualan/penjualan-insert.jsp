...
<head>
    ...
    <title>Insert Penjualan | Sistem Informasi PT. Farmasi OK</title>
...
<!-- #END# Right Sidebar -->
<jsp:useBean id="insert" class="penjualan.InsertPenjualan"/>
<script type="text/javascript">
    
    function berhasil(){
        alert("Berhasil Input Transaksi");
        window.location.href = "penjualan-insert.jsp";
    }
    
    function gagal(){
        alert("Gagal Input Transaksi\nAda Kesalahan Dalam Input Transaksi.");
        window.location.href = "penjualan-insert.jsp";
    }
    
    function stokHabis(){
        alert("Berhasil Input Transaksi. \nStok Obat dalam keadaan limit (habis)");
        window.location.href = "penjualan-insert.jsp";
    }
    
    function gagalStokKurang(){
        alert("Gagal Input Transaksi \nStok Obat tidak mencukupi (stok kurang) \nSilahkan Input Kembali Transaksi.");
        window.location.href = "penjualan-insert.jsp";
    }
</script>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>INSERT DATA PENJUALAN</h2>
                            <small>(Pastikan ID semuanya sudah terdaftar)</small>
                    ...
                    <% 
                        if (request.getParameter("jumlah") != null && request.getParameter("jumlah") != "") {
                            insert.idPelanggan = request.getParameter("idpelanggan");
                    ...
                    <%} else if (insert.a == 2){%>
                        <script>gagal();</script>  
                    <%  } else if (insert.a == 3){%>
                        <script>stokHabis();</script>  
                    <%  } else if (insert.a == 4){%>
                        <script>gagalStokKurang();</script>  
                    <%  } %>
                                        ...
                                        <select name="idpelanggan" required>
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    while(rs.next()){%>
                                                        <option value="<%= rs.getString("id_pelanggan") %>"><%= rs.getString("nama_pelanggan") %></option>
                                                    <%}
                                                    stmt.close();
                                                    conn.close();
                                                        } catch (Exception e){
