...
<head>
    ...
    <title>Search Penjualan | Sistem Informasi PT. Farmasi OK</title>
    <!-- Favicon-->
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="penjualan-insert.jsp">Insert</a>
                            </li>
                            <li class="active">
                                <a href="penjualan-search.jsp">Search</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <div class="card">
                        ...
                        <%! 
                            ...
                            <% try {
                                ...
                                String sql = "select penjualan.kode_transaksi, nama_pelanggan, nama_pegawai, id_obat, nama_obat, total, jumlah, tanggal from penjualan INNER JOIN pelanggan USING (id_pelanggan) INNER JOIN pegawai USING (id_pegawai) INNER JOIN obat USING (id_obat) INNER JOIN detail_penjualan USING (no)";
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="penjualan-search.jsp?delete=<%=rs.getString("kode_transaksi")%>&jumlah=<%=rs.getString("jumlah")%>&idobat=<%=rs.getString("id_obat")%>" onclick="return confirm('Apakah Anda Akan Menghapus Data Obat Berikut ini ?')"><center><i class="fa fa-bitbucket fa-fw"></i></center></td>
                                        </tr>
                                        <% }
                                            stmt.close();
                                            conn.close();
...
<script type="text/javascript">
    ...
    function berhasil(){
        ...
        window.location.href = "penjualan-search.jsp";
    }
    
</script>                                    
                                    <jsp:useBean id="delete" class="penjualan.DeletePenjualan"/>
            <% 
                if (request.getParameter("delete") != null && request.getParameter("delete") != "") {
                        delete.kodeTransaksi = request.getParameter("delete");
                        delete.jumlahPenjualan = Integer.parseInt(request.getParameter("jumlah"));
                        delete.idObat = request.getParameter("idobat");
                        delete.run();
                    }
