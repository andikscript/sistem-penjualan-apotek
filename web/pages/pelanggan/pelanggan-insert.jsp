...
<head>
    ...
    <title>Insert Pelanggan | Sistem Informasi PT. Farmasi OK</title>
...
<script type="text/javascript">
    ...
    function berhasil(){
        ...
        window.location.href = "pelanggan-insert.jsp";
    }
    ...
    <section class="content">
        <div class="container-fluid">
            <jsp:useBean id="insert" class="pelanggan.InsertPelanggan"/>
            <% 
                if (request.getParameter("namapelanggan") != null && request.getParameter("namapelanggan") != "" && request.getParameter("alamat") != null && request.getParameter("alamat") != "" && request.getParameter("nohp") != null && request.getParameter("nohp") != "" && request.getParameter("email") != null && request.getParameter("email") != "") {
                    insert.namaPelanggan = request.getParameter("namapelanggan");
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="namapelanggan" maxlength="70" required>
                                        <label class="form-label">Nama Pelanggan</label>
                                    </div>
                                    <div class="help-info">Max. Panjang: 70 karakter</div>
                                </div>  
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    ...
                                    <div class="help-info">Max. Panjang: 255 karakter</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    ...
                                    <div class="help-info">Max. Panjang: 20 karakter </div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
