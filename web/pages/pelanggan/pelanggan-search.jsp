...
<head>
    ...
    <title>Search Pelanggan | Sistem Informasi PT. Farmasi OK</title>
    <!-- Favicon-->
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="pelanggan-update.jsp?update=<%=rs.getString("id_pelanggan")%>&nama=<%=rs.getString("nama_pelanggan")%>&alamat=<%=rs.getString("alamat")%>&nohp=<%=rs.getString("no_hp")%>&email=<%=rs.getString("email")%>"" onclick="return confirm('Apakah Anda Akan Mengupdate Data Pelanggan Berikut ini ?')"><center><i class="fa fa-edit fa-fw"></i></center></a></td>
                                        </tr>
                                        <% }
                                            stmt.close();
                                            conn.close();
